...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Doce sonho" },
      { property: "og:title", content: "Doce sonho" },
      { name: "twitter:title", content: "Doce sonho" },
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/kjZ0IWw9YpcmF5ihdASM5MDGBDO2/social-images/social-1783786620753-8715.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/kjZ0IWw9YpcmF5ihdASM5MDGBDO2/social-images/social-1783786620753-8715.webp" },
    ],
    links: [
